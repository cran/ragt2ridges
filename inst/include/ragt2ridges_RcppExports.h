...
#ifndef __ragt2ridges_RcppExports_h__
#define __ragt2ridges_RcppExports_h__
...
namespace ragt2ridges {
    ...
    inline Rcpp::List _armaVAR1_ridgeML(Rcpp::NumericVector& Yraw, const double& lambdaA, const double lambdaP, arma::mat& targetA, arma::mat& targetP, std::string targetPtype, std::string fitA, arma::mat& unbalanced, bool& diagP, bool& efficient, const int& nInit, const double& minSuccDiff) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_ridgeML(Rcpp::wrap(Yraw), Rcpp::wrap(lambdaA), Rcpp::wrap(lambdaP), Rcpp::wrap(targetA), Rcpp::wrap(targetP), Rcpp::wrap(targetPtype), Rcpp::wrap(fitA), Rcpp::wrap(unbalanced), Rcpp::wrap(diagP), Rcpp::wrap(efficient), Rcpp::wrap(nInit), Rcpp::wrap(minSuccDiff));
        }
    ...
    inline Rcpp::List _armaEigenDecomp_blockDiagOnly(const arma::mat symMat, const arma::ivec blockDims) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaEigenDecomp_blockDiagOnly(Rcpp::wrap(symMat), Rcpp::wrap(blockDims));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline arma::mat _armaVAR1_Shat_ML(Rcpp::NumericVector Yraw, const arma::mat A) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_Shat_ML(Rcpp::wrap(Yraw), Rcpp::wrap(A));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline arma::mat _armaVAR1_COVYhat(Rcpp::NumericVector Yraw) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_COVYhat(Rcpp::wrap(Yraw));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline arma::mat _armaVAR1_VARYhat(Rcpp::NumericVector Yraw, bool efficient, arma::mat unbalanced) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_VARYhat(Rcpp::wrap(Yraw), Rcpp::wrap(efficient), Rcpp::wrap(unbalanced));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline arma::mat _armaVAR1_Ahat_zeros(const arma::mat& P, arma::mat& COVY, const arma::mat& eigvecVARY, const arma::vec& eigvalVARY, const double& lambdaA, const arma::mat& targetA, std::string fitA, const arma::uvec& zerosR, const arma::uvec& zerosC, std::string& zerosAfit) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_Ahat_zeros(Rcpp::wrap(P), Rcpp::wrap(COVY), Rcpp::wrap(eigvecVARY), Rcpp::wrap(eigvalVARY), Rcpp::wrap(lambdaA), Rcpp::wrap(targetA), Rcpp::wrap(fitA), Rcpp::wrap(zerosR), Rcpp::wrap(zerosC), Rcpp::wrap(zerosAfit));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline arma::mat _armaP_defaultTarget(arma::mat S, std::string targetType, const double fraction, double const multiplier) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaP_defaultTarget(Rcpp::wrap(S), Rcpp::wrap(targetType), Rcpp::wrap(fraction), Rcpp::wrap(multiplier));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline arma::cube _armaVAR_array2cube_withMissing(Rcpp::NumericVector& Yraw, const arma::uvec& unbalancedR, const arma::uvec& unbalancedC) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR_array2cube_withMissing(Rcpp::wrap(Yraw), Rcpp::wrap(unbalancedR), Rcpp::wrap(unbalancedC));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline arma::cube _armaVAR_array2cube_withoutMissing(Rcpp::NumericVector& Yraw) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR_array2cube_withoutMissing(Rcpp::wrap(Yraw));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline Rcpp::List _armaEigenDecomp(const arma::mat symMat) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaEigenDecomp(Rcpp::wrap(symMat));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline const double _armaVAR1_convergenceEvaluation(arma::mat Ahat, arma::mat Aprev, arma::mat Phat, arma::mat Pprev) {
        ...
        if (p__armaVAR1_convergenceEvaluation == NULL) {
            validateSignature("const double(*_armaVAR1_convergenceEvaluation)(arma::mat,arma::mat,arma::mat,arma::mat)");
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_convergenceEvaluation(Rcpp::wrap(Ahat), Rcpp::wrap(Aprev), Rcpp::wrap(Phat), Rcpp::wrap(Pprev));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
            throw Rcpp::exception(as<std::string>(__result).c_str());
        return Rcpp::as<const double >(__result);
    }
    ...
    inline arma::mat _armaVAR1_Ahat_ridgeML(arma::mat P, arma::mat COVY, const arma::mat eigvecVARY, const arma::colvec eigvalVARY, const double lambdaA, arma::mat targetA) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_Ahat_ridgeML(Rcpp::wrap(P), Rcpp::wrap(COVY), Rcpp::wrap(eigvecVARY), Rcpp::wrap(eigvalVARY), Rcpp::wrap(lambdaA), Rcpp::wrap(targetA));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline arma::mat _armaVAR1_Ahat_ridgeSS(arma::mat VARY, arma::mat COVY, const double& lambdaA, arma::mat& targetA) {
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_Ahat_ridgeSS(Rcpp::wrap(VARY), Rcpp::wrap(COVY), Rcpp::wrap(lambdaA), Rcpp::wrap(targetA));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline const double _armaVAR1_loglik_LOOCVinternal(arma::vec Yt1, arma::vec Yt0, arma::mat A, arma::mat P) {
        ...
        if (p__armaVAR1_loglik_LOOCVinternal == NULL) {
            validateSignature("const double(*_armaVAR1_loglik_LOOCVinternal)(arma::vec,arma::vec,arma::mat,arma::mat)");
        ...
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_loglik_LOOCVinternal(Rcpp::wrap(Yt1), Rcpp::wrap(Yt0), Rcpp::wrap(A), Rcpp::wrap(P));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
    ...
    inline const double _armaVAR1_loglik(Rcpp::NumericVector Yraw, arma::mat A, arma::mat P) {
        ...
        if (p__armaVAR1_loglik == NULL) {
            validateSignature("const double(*_armaVAR1_loglik)(Rcpp::NumericVector,arma::mat,arma::mat)");
            p__armaVAR1_loglik = (Ptr__armaVAR1_loglik)R_GetCCallable("ragt2ridges", "ragt2ridges__armaVAR1_loglik");
        }
        RObject __result;
        {
            RNGScope __rngScope;
            __result = p__armaVAR1_loglik(Rcpp::wrap(Yraw), Rcpp::wrap(A), Rcpp::wrap(P));
        }
        if (__result.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (__result.inherits("try-error"))
...
#endif // __ragt2ridges_RcppExports_h__
